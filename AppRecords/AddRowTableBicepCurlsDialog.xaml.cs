...
{
    public partial class AddRowTableBicepCurlsDialog : Window
    {
        private int _userId;
        private int _number;
        ...
        public AddRowTableBicepCurlsDialog(int userId)
        {
            _userId = userId;
            InitializeComponent();
        }
        ...
        {
            return new RowTableBicepCurls(_userId, _number, _rodWeight, _time, _date);
        }
