...
{
    public partial class AddRowTableBackSquatsDialog : Window
    {
        private int _userId;
        private int _number;
        ...
        public AddRowTableBackSquatsDialog(int userId)
        {
            _userId = userId;
            InitializeComponent();
        }
        ...
        {
            return new RowTableBackSquats(_userId, _number, _rodWeight, _time, _date);
        }
